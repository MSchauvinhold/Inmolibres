...
export async function proxy(request: NextRequest) {
  ...
  const crmPrefixes = ["/dashboard", "/propiedades", "/clientes", "/visitas", "/alquileres", "/consultas", "/configuracion"];
  if (crmPrefixes.some((p) => pathname.startsWith(p))) {
    ...
    if (inmobiliariaEstado === "SUSPENDIDA" || (inmobiliariaEstado !== "ACTIVA" && inmobiliariaEstado !== "PRUEBA")) {
